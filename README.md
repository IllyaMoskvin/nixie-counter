...
There's also a few soldered and heat-shrinked connections here: wire splices and the rear panel-mount components. For wires that had to be inserted into the screw and push-button terminals, I tinned the stranded ends first. I've learned afterwards that doing so is [bad practice](https://electronics.stackexchange.com/questions/29861/tinning-wires-that-will-be-screwed-in-to-a-chocolate-block-terminal-strip): tinning can cause screw terminal connections to [loosen overtime](https://cdn.thomasnet.com/ccp/00142951/263810.pdf). I haven't noticed issues over these past two years, but I'm keeping an eye on it.
